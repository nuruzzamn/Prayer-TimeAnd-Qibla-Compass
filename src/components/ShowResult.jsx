  ...
  return (
    <div className='bg-transparent font-bold text-black w-full'>
      <section className="flex flex-1 gap-5 pt-4 px-2 bg-transparent justify-evenly items-center">
        ...
        <p className='w-[70px] h-8 text-center text-white bg-blue-900 border-blue-900 p-1'> {(Fajr==="NaN:undefined AM"? "3.13 AM" : Fajr)}</p>
      </section>
      ...
      <section className="flex flex-1 gap-5 pt-1 px-2 bg-transparent justify-evenly items-center">
        ...
        <p className='w-[70px] h-8 text-center text-white bg-blue-900 border-blue-900 p-1'>{(Dhuhr==="NaN:undefined AM"? "12.35 PM" : Dhuhr)}</p>
      </section>
